"""
Experimental validation of the classical Stern ISD implementation.
"""

import random
import time

from isd_hqc.algorithms.stern import stern_decode_classical
...
def run_stern_validation(
    ...
    for experiment_id in range(number_of_experiments):
        ...
        decoder_seed = seed + experiment_id

        start_time = time.perf_counter()

        decoded_error = stern_decode_classical(
...
def main() -> None:
    ...
    print("Stern validation results")
